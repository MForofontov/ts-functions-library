...
describe('calculateTriangularNumber', () => {
    ...
    it('4. should throw an error for a negative integer', () => {
        const input: number = -5;
        expect(() => calculateTriangularNumber(input)).toThrow('Input must be a non-negative integer');
    });
    ...
    it('5. should throw an error for a floating-point number', () => {
        ...
        expect(() => calculateTriangularNumber(input)).toThrow('Input must be an integer');
    });
    ...
    it('6. should throw an error for NaN input', () => {
        ...
        expect(() => calculateTriangularNumber(input)).toThrow('Input must be a number');
    });
});

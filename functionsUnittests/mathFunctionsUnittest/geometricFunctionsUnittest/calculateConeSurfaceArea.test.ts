...
describe('calculateConeSurfaceArea', () => {
    ...
    it('1. should return the correct surface area for positive radius and slant height', () => {
        ...
        const expected: number = Math.PI * Math.pow(radius, 2) + Math.PI * radius * slantHeight;
    ...
    it('6. should throw an error for negative radius', () => {
        const radius: number = -5;
        const slantHeight: number = 10;
        expect(() => calculateConeSurfaceArea(radius, slantHeight)).toThrow('Radius must be a non-negative number');
    });
    ...
    it('7. should throw an error for negative slant height', () => {
        const radius: number = 5;
        const slantHeight: number = -10;
        expect(() => calculateConeSurfaceArea(radius, slantHeight)).toThrow('Slant height must be a non-negative number');
    });

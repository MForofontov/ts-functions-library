...
describe('calculateTrapezoidArea', () => {
    ...
    it('8. should throw an error for negative base1', () => {
        ...
        const base2: number = 7;
        const height: number = 3;
        expect(() => calculateTrapezoidArea(base1, base2, height)).toThrow('Base1, base2, and height must be non-negative numbers');
    });
    ...
    it('11. should throw an error for NaN base1', () => {
        ...
        const base2: number = 7;
        const height: number = 3;
        expect(() => calculateTrapezoidArea(base1, base2, height)).toThrow('Base1, base2, and height must be numbers');
    });

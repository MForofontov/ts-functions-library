...
describe('calculateCylinderVolume', () => {
    ...
    it('6. should throw an error for negative radius', () => {
        const radius: number = -5;
        const height: number = 10;
        expect(() => calculateCylinderVolume(radius, height)).toThrow('Radius must be a non-negative number');
    });
    ...
    it('7. should throw an error for negative height', () => {
        const radius: number = 5;
        const height: number = -10;
        expect(() => calculateCylinderVolume(radius, height)).toThrow('Height must be a non-negative number');
    });
    ...
    it('8. should throw an error for NaN radius', () => {
        ...
        const height: number = 10;
        expect(() => calculateCylinderVolume(radius, height)).toThrow('Radius and height must be numbers');
    });

...
describe('calculateEllipseArea', () => {
    ...
    it('6. should throw an error for negative semi-major axis', () => {
        const semiMajor: number = -5;
        const semiMinor: number = 3;
        expect(() => calculateEllipseArea(semiMajor, semiMinor)).toThrow('Semi-major axis must be a non-negative number');
    });
    ...
    it('7. should throw an error for negative semi-minor axis', () => {
        const semiMajor: number = 5;
        const semiMinor: number = -3;
        expect(() => calculateEllipseArea(semiMajor, semiMinor)).toThrow('Semi-minor axis must be a non-negative number');
    });
    ...
    it('8. should throw an error for NaN semi-major axis', () => {
        ...
        const semiMinor: number = 3;
        expect(() => calculateEllipseArea(semiMajor, semiMinor)).toThrow('Semi-major and semi-minor axes must be numbers');
    });

...
describe('calculateRectanglePerimeter', () => {
    ...
    it('7. should throw an error for negative width', () => {
        const width: number = -10;
        const height: number = 5;
        expect(() => calculateRectanglePerimeter(width, height)).toThrow('Width and height must be non-negative numbers');
    });
    ...
    it('9. should throw an error for NaN width', () => {
        ...
        const height: number = 5;
        expect(() => calculateRectanglePerimeter(width, height)).toThrow('Width and height must be numbers');
    });

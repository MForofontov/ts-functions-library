...
describe('calculateStandardDeviation', () => {
    ...
    it('1. should return the standard deviation of an array of positive numbers', () => {
        ...
        expect(calculateStandardDeviation([10, 20, 30, 40, 50])).toBeCloseTo(14.142);
    });
    ...
    it('8. should handle arrays with large numbers', () => {
        expect(calculateStandardDeviation([1000000000, 2000000000, 3000000000])).toBeCloseTo(816496580.927);
        expect(calculateStandardDeviation([-1000000000, -2000000000, -3000000000])).toBeCloseTo(816496580.927);
    });

    // Test case 9: Standard deviation of an array with very small numbers
    it('9. should handle arrays with very small numbers', () => {
        expect(calculateStandardDeviation([0.0000001, 0.0000002, 0.0000003])).toBeCloseTo(0.0000001);
        expect(calculateStandardDeviation([-0.0000001, -0.0000002, -0.0000003])).toBeCloseTo(0.0000001);
    });

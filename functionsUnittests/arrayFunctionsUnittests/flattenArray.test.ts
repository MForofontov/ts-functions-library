...
describe('flattenArray', () => {
    ...
    it('6. should flatten an array containing null and undefined', () => {
        ...
        expect(flattenArray<number | null | undefined>(arr)).toEqual([1, null, 2, undefined, 3]);
    });
    ...
    it('9. should flatten an array containing functions', () => {
        ...
        expect(flattenArray<number | (() => number)>(arr)).toEqual([1, func1, 2, func2, 3]);
    });
    ...
    it('12. should flatten an array containing regex', () => {
        ...
        expect(flattenArray<number | RegExp>(arr)).toEqual([1, regex1, 2, regex2, 3]);
    });

...
describe('businessDaysBetween', () => {
    ...
    // Error test case 1: Get the number of business days between two dates where the first date is NaN (should throw an error)
    it('7. should throw an error for a NaN first date', () => {
        const start: Date = new Date(NaN);
        const end: Date = new Date('2023-09-22');
        expect(() => businessDaysBetween(start, end)).toThrow('Invalid date');
    });

    // Error test case 2: Get the number of business days between two dates where the second date is NaN (should throw an error)
    ...
    // Error test case 3: Get the number of business days between two dates where the start date is invalid (should throw an error)
    ...
    // Error test case 4: Get the number of business days between two dates where the end date is invalid (should throw an error)
    ...
    // Error test case 5: Get the number of business days between two dates where the start date is after the end date (should throw an error)
    it('11. should throw an error for a start date that is after the end date', () => {

...
describe('keysToCamelCase', () => {
    ...
    it('4. should convert keys of an object with various data types to camelCase', () => {
        const obj = { 'first_name': 'John', 'age_years': 30, 'is_active': true, 'address_info': { 'street_name': 'Main St' } };
        const result = keysToCamelCase(obj);
        const expected = { firstName: 'John', ageYears: 30, isActive: true, addressInfo: { streetName: 'Main St' } };
        expect(result).toEqual(expected);
    });

import { isEmptyObject } from '../../objectFunctions/isEmptyObject';
...
describe('isEmptyObject', () => {
    ...
    it('4. should return false for an array', () => {
        const arr = [1, 2, 3];
        const result = isEmptyObject(arr);
        expect(result).toBe(false);
    });

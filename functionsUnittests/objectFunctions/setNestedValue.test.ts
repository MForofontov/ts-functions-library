...
describe('setNestedValue', () => {
    ...
    it('4. should set a nested value in an object with various data types', () => {
        ...
        const expected = { a: { b: { c: true, d: 'string', e: null, f: undefined, g: [1, 2, 3], h: { i: 5 } } } };
        expect(obj).toEqual(expected);
    });

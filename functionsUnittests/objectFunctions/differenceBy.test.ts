...
describe('differenceBy', () => {
    ...
    it('7. should compare nested objects correctly', () => {
        ...
        const comparator = (a: any, b: any) => JSON.stringify(a) === JSON.stringify(b);
        const result = differenceBy(obj1, obj2, comparator);
